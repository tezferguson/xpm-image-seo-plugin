...
class XPM_Image_SEO {
    ...
    public function settings_init() {
        ...
        add_settings_section(
            ...
            __('Image Optimization', 'xpm-image-seo'),
        ...
        // API Settings
        add_settings_field('api_key', __('OpenAI API Key', 'xpm-image-seo'), array($this, 'api_key_render'), 'xpm_image_seo', 'xpm_image_seo_api_section');
        
        // Keyword Settings
        add_settings_field('global_keywords', __('Global Keywords', 'xpm-image-seo'), array($this, 'global_keywords_render'), 'xpm_image_seo', 'xpm_image_seo_keywords_section');
        add_settings_field('use_contextual_keywords', __('Use Contextual Keywords', 'xpm-image-seo'), array($this, 'use_contextual_keywords_render'), 'xpm_image_seo', 'xpm_image_seo_keywords_section');
        add_settings_field('keyword_priority', __('Keyword Priority', 'xpm-image-seo'), array($this, 'keyword_priority_render'), 'xpm_image_seo', 'xpm_image_seo_keywords_section');
        add_settings_field('max_keywords', __('Max Keywords Per Image', 'xpm-image-seo'), array($this, 'max_keywords_render'), 'xpm_image_seo', 'xpm_image_seo_keywords_section');
        
        // Optimization Settings
        add_settings_field('auto_optimize', __('Auto-optimize on Upload', 'xpm-image-seo'), array($this, 'auto_optimize_render'), 'xpm_image_seo', 'xpm_image_seo_optimization_section');
        add_settings_field('compression_quality', __('Compression Quality', 'xpm-image-seo'), array($this, 'compression_quality_render'), 'xpm_image_seo', 'xpm_image_seo_optimization_section');
        add_settings_field('max_width', __('Maximum Width', 'xpm-image-seo'), array($this, 'max_width_render'), 'xpm_image_seo', 'xpm_image_seo_optimization_section');
        add_settings_field('max_height', __('Maximum Height', 'xpm-image-seo'), array($this, 'max_height_render'), 'xpm_image_seo', 'xpm_image_seo_optimization_section');
        add_settings_field('backup_originals', __('Backup Original Images', 'xpm-image-seo'), array($this, 'backup_originals_render'), 'xpm_image_seo', 'xpm_image_seo_optimization_section');
        add_settings_field('convert_to_webp', __('Convert to WebP', 'xpm-image-seo'), array($this, 'convert_to_webp_render'), 'xpm_image_seo', 'xpm_image_seo_optimization_section');
        
        // Behavior Settings
        add_settings_field('auto_generate', __('Auto-generate for new uploads', 'xpm-image-seo'), array($this, 'auto_generate_render'), 'xpm_image_seo', 'xpm_image_seo_behavior_section');
        add_settings_field('prompt', __('Custom Prompt', 'xpm-image-seo'), array($this, 'prompt_render'), 'xpm_image_seo', 'xpm_image_seo_behavior_section');
        
        // Field Update Settings
        add_settings_field('update_title', __('Update Image Title', 'xpm-image-seo'), array($this, 'update_title_render'), 'xpm_image_seo', 'xpm_image_seo_fields_section');
        add_settings_field('update_description', __('Update Image Description', 'xpm-image-seo'), array($this, 'update_description_render'), 'xpm_image_seo', 'xpm_image_seo_fields_section');
        add_settings_field('skip_existing', __('Skip Existing Content', 'xpm-image-seo'), array($this, 'skip_existing_render'), 'xpm_image_seo', 'xpm_image_seo_fields_section');
    }
    ...
    public function optimization_section_callback() {
        echo '<p>' . __('Configure image optimization settings for automatic compression and resizing. This helps improve website speed and SEO rankings.', 'xpm-image-seo') . '</p>';
    ...
    public function fields_section_callback() {
        echo '<p>' . __('Choose which image fields to update with the generated content. Caption is always skipped.', 'xpm-image-seo') . '</p>';
    }
    ...
    public function auto_optimize_render() {
        $options = get_option($this->option_name);
        $auto_optimize = isset($options['auto_optimize']) ? $options['auto_optimize'] : 0;
            ...
            <div class="xpm-settings-container">
                ...
                <div class="xpm-settings-sidebar">
                    ...
                    <div class="xpm-info-box">
                        ...
                        <p><?php _e('Complete image SEO and optimization solution. Boost your website\'s SEO and performance with AI-powered alt text and smart image compression.', 'xpm-image-seo'); ?></p>
    ...
    // Continue with optimization and alt text methods...
    // [Rest of the methods would continue here - optimization functions, AJAX handlers, etc.]
    // Due to length constraints, I'll provide the remaining methods in the next files
}
